...
static const GridVariantData GRID_VARIANTS[] = {
  { GridVariant::NL_BRIX, "NL_BRIX", "Nederlands BRIX", "nl", "brix", LED_COUNT_GRID_NL_BRIX, LED_COUNT_EXTRA_NL_BRIX, LED_COUNT_TOTAL_NL_BRIX, LETTER_GRID_NL_BRIX, WORDS_NL_BRIX, WORDS_NL_BRIX_COUNT, EXTRA_MINUTES_NL_BRIX, EXTRA_MINUTES_NL_BRIX_COUNT, MinuteLayout::AfterGrid }
};
...
// Public state
const char* const* LETTER_GRID = LETTER_GRID_NL_BRIX;
const WordPosition* ACTIVE_WORDS = WORDS_NL_BRIX;
size_t ACTIVE_WORD_COUNT = WORDS_NL_BRIX_COUNT;
const uint16_t* EXTRA_MINUTE_LEDS = EXTRA_MINUTES_NL_BRIX;
size_t EXTRA_MINUTE_LED_COUNT = EXTRA_MINUTES_NL_BRIX_COUNT;
