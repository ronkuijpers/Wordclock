...
#define FIRMWARE_VERSION "2025.12.04"
#define UI_VERSION "2025.12.04"

#define DATA_PIN 4
#define LOGO_DATA_PIN_1 18
#define LOGO_DATA_PIN_2 19
#define LOGO_STRIP_COUNT 2
#define LOGO_LED_PER_STRIP 13
#define LOGO_LED_TOTAL (LOGO_STRIP_COUNT * LOGO_LED_PER_STRIP)
